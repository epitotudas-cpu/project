    ...
    if (raw) {
      ...
      if (Array.isArray(parsed) && parsed.length > 0) {
        const sanitized = parsed.map((b: any) => ({
          ...
          isbn: b.isbn || '',
          coverImage: b.generatedCoverImageUrl || b.coverImageUpload || b.coverImageUrl || b.coverImage || 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=80&w=600&auto=format&fit=crop',
