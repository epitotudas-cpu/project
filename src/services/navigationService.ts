...
export const DEFAULT_NAV_ITEMS: MenuItem[] = [
  ...
  { id: 'nav-articles', label: 'Cikkek & Útmutatók', page: 'category?type=hirek', parentId: null, isActive: true, displayOrder: 2 },
...
const STORAGE_KEY = 'epitotudas_nav_items_v6';
...
function normalizeNavLabels(items: MenuItem[]): MenuItem[] {
  ...
  const itemMap: Record<string, { label: string; page: string; displayOrder?: number }> = {
    'nav-articles': { label: 'Cikkek & Útmutatók', page: 'category?type=hirek', displayOrder: 2 },
