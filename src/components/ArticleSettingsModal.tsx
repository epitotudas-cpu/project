...
import { X, Save, Settings, CheckCircle2, AlertCircle } from 'lucide-react';
import {
  getArticleSettings,
  saveArticleSettings,
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSave} className="px-6 py-5 space-y-6">
          ...
          {/* Footer */}
          <div style={{ backgroundColor: headerBg, borderColor: cardBorder }} className="flex flex-wrap items-center justify-between gap-3 pt-3 pb-3 px-4 border-t sticky bottom-0 z-10 rounded-b-2xl backdrop-blur-md">
            <div className="flex flex-wrap items-center gap-3 ml-auto">
              ...
              <button
                ...
                onClick={onClose}
                disabled={saving}
                className="px-4 py-2 text-xs font-bold text-gray-400 hover:text-gray-200 disabled:opacity-40 transition-colors cursor-pointer"
              >
                Mégse
              </button>
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 text-xs font-black rounded-xl hover:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed transition-colors shadow-md cursor-pointer"
              >
