        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {activeTab === 'preview' ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* MODAL FOOTER */}
              <div style={{ backgroundColor: headerBg, borderColor: cardBorder }} className="flex flex-wrap items-center justify-between pt-4 border-t shrink-0 sticky bottom-0 z-10 py-3 px-3 rounded-b-2xl backdrop-blur-md">
                ...
                <div className="flex flex-wrap items-center gap-3 ml-auto">
                  ...
                  >
                    {saving ? (
                      ...
                      <>
                        <Save size={16} /> {isCreate ? 'Cikk Létrehozása' : 'Módosítások Mentése'}
                      </>
                    )}
                  </button>
                </div>
