...
export function BannerCreativeEditor() {
  ...
  const getBackgroundClasses = (bg: BackgroundStyle) => {
    switch (bg) {
      ...
      case 'soft_gradient':
        return 'bg-gradient-to-r from-teal-900 via-slate-900 to-emerald-950 text-white border border-teal-500/40 shadow-md';
      default:
  ...
  const getButtonClasses = (btn: ButtonStyle) => {
    switch (btn) {
      ...
      case 'amber_gold':
        return 'bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black border border-emerald-400/50';
      case 'dark_slate':
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 bg-[#161616] border border-[#222] rounded-2xl">
              ...
              <div>
                ...
                >
                  ...
                  <option value="amber_gold">Smaragdzöld Gomb</option>
                  ...
                  <div className={`relative z-20 h-full flex flex-col p-4 sm:p-5 md:p-6 max-w-3xl ${
                    ...
                    {activeCreative.cta_text && activeCreative.cta_text.trim() !== '' && (
                      <div className="mt-3 shrink-0">
                        <div className="inline-flex items-center justify-center gap-2 h-9 px-4 rounded-xl font-extrabold text-xs bg-emerald-400 text-slate-950 shadow-md">
    ...
    >
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2 flex-wrap text-[11px] text-gray-400 pt-2 border-t border-[#1F1F1F]">
          ...
          <span className="bg-[#1A1A1A] border border-[#2B2B2B] px-2 py-0.5 rounded-lg flex items-center gap-1">
            <RefreshCw size={11} className="text-emerald-400" /> {creative.transition_effect || 'slide_left'}
          </span>
