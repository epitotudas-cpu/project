...
export default function PartnerApplicationPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white relative overflow-hidden pb-20 selection:bg-[#3B82F6] selection:text-white">
      {/* Ambient Background Lights & Grid Pattern */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#3B82F6]/20 via-[#3B82F6]/5 to-transparent pointer-events-none z-0" />
      <div className="absolute top-1/4 right-0 w-96 h-96 bg-[#3B82F6]/10 rounded-full blur-3xl pointer-events-none z-0" />
      <div className="absolute bottom-10 left-10 w-96 h-96 bg-[#3B82F6]/10 rounded-full blur-3xl pointer-events-none z-0" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 relative z-10 space-y-8">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4 border-b border-white/10 pb-4">
          <div className="flex items-center gap-2 text-xs font-semibold text-gray-400">
            <a
              href="/"
              className="inline-flex items-center gap-1.5 hover:text-[#3B82F6] transition-colors"
            >
              <ArrowLeft size={14} /> Kezdőlap
            </a>
            <ChevronRight size={12} className="text-gray-600" />
            <span className="text-[#3B82F6] font-bold">Partneri Jelentkezés</span>
          </div>

          <a
            href="/#partnerek"
            className="inline-flex items-center gap-1.5 text-xs font-extrabold text-[#3B82F6] bg-[#3B82F6]/10 border border-[#3B82F6]/30 px-3.5 py-1.5 rounded-full hover:bg-[#3B82F6]/20 transition-all"
          >
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 pt-2">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#3B82F6]/15 border border-[#3B82F6]/30 text-[#3B82F6] text-xs font-black uppercase tracking-wider backdrop-blur-md">
            <Sparkles size={14} className="text-[#3B82F6] animate-pulse" />
            2026 ÉPÍTŐIPARI & OKTATÁSI PARTNERI PROGRAM
          </div>

          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-white leading-tight">
            Partneri &amp; Iskolai <span className="text-[#3B82F6]">Csatlakozás</span>
          </h1>
        ...
        {submitted ? (
          <div className="max-w-2xl mx-auto bg-slate-900/90 border-2 border-emerald-500/40 rounded-3xl p-8 md:p-12 shadow-2xl text-center space-y-6 backdrop-blur-xl animate-fade-in my-8">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-4 text-left space-y-2 text-xs text-gray-300 max-w-md mx-auto">
              ...
              <p className="flex justify-between">
                ...
                <strong className="text-[#3B82F6] font-bold">{email}</strong>
              </p>
            </div>
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-3">
              <a
                ...
                className="w-full sm:w-auto px-8 py-3.5 hover:bg-[#155CD0] font-black rounded-xl transition-all shadow-lg text-sm flex items-center justify-center gap-2 cursor-pointer"
              >
                Vissza a Kezdőlapra
              </a>
              <a
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start pt-4">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="bg-slate-900/80 border border-white/10 rounded-3xl p-6 sm:p-8 space-y-6 backdrop-blur-md shadow-xl">
                <div className="space-y-2 border-b border-white/10 pb-4">
                  <span className="text-xs font-black uppercase tracking-wider text-[#3B82F6]">PARTNERI ELŐNYÖK</span>
                ...
                <div className="pt-4 border-t border-white/10 space-y-2">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {[
                      ...
                      >
                        <Check size={11} className="text-[#3B82F6]" /> {cat}
                      </span>
                    ))}
                  </div>
                </div>
            ...
            <div className="lg:col-span-7">
              <div className="bg-slate-900/90 border-2 border-[#3B82F6]/30 rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl backdrop-blur-xl space-y-6 relative overflow-hidden">
                ...
                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                  <div>
                    <h2 className="text-xl font-extrabold text-white flex items-center gap-2">
                      <Building2 size={22} className="text-[#3B82F6]" /> Csatlakozási Űrlap
                    </h2>
                    <p className="text-xs text-gray-400 mt-1">
                      Töltse ki az alábbi mezőket a regisztrációs kérelem elküldéséhez.
                    </p>
                  </div>
                  <span className="text-[10px] font-black uppercase tracking-wider bg-[#3B82F6]/20 text-[#3B82F6] border border-[#3B82F6]/40 px-3 py-1 rounded-full shrink-0 hidden sm:inline-block">
                    Gyors Elbírálás
                  </span>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5 text-xs">
                  ...
                  <div className="space-y-3">
                    <span className="text-[11px] font-black uppercase tracking-wider text-[#3B82F6] block flex items-center gap-1.5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="font-semibold text-gray-300 block">
                          Szervezet / Cég Neve <span className="text-[#3B82F6]">*</span>
                        </label>
                        <input
                          type="text"
                          required
                      ...
                      <div className="space-y-1.5">
                        <label className="font-semibold text-gray-300 block">
                          Szervezet Típusa <span className="text-[#3B82F6]">*</span>
                        </label>
                        <select
                          value={category}
                          onChange={(e) => setCategory(e.target.value as PartnerCategory)}
                          className="w-full bg-slate-950 border border-white/15 text-white rounded-xl px-4 py-3 text-xs md:text-sm font-semibold focus:outline-none focus:border-[#3B82F6] focus:ring-1 focus:ring-[#3B82F6] transition-all cursor-pointer shadow-inner"
                        >
                  ...
                  <div className="space-y-3 pt-2 border-t border-white/10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="font-semibold text-gray-300 block">
                          Kapcsolattartó Neve <span className="text-[#3B82F6]">*</span>
                        </label>
                        <input
                          type="text"
                          required
                      ...
                      <div className="space-y-1.5">
                        <label className="font-semibold text-gray-300 block">
                          E-mail Cím <span className="text-[#3B82F6]">*</span>
                        </label>
                        <input
                          type="email"
                          required
                  ...
                  <div className="space-y-1.5 pt-2 border-t border-white/10">
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full bg-slate-950 border border-white/15 text-white rounded-xl p-4 text-xs md:text-sm font-semibold resize-none focus:outline-none focus:border-[#3B82F6] focus:ring-1 focus:ring-[#3B82F6] transition-all shadow-inner"
                    />
                  </div>
                  ...
                  <div className="pt-3">
                    <button
                      ...
                      disabled={loading}
                      style={{ backgroundColor: '#3B82F6', color: '#FFFFFF' }}
                      className="w-full py-4 font-black rounded-2xl shadow-xl hover:bg-[#155CD0] transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 text-sm hover:scale-[1.01]"
                    >
                      {loading ? (
                        'Jelentkezés küldése...'
                      ) : (
